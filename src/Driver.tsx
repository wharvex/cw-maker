...
/**
 * Finds the {@link Word} objects that will fit on the puzzle
 * only building on {@link Word} objects already on it.
 *
 * @param puzModel - A 2D array of cell models
 */
...
export const driver = (
    ...
    if (getBest) {
        [props.dispWordsQty, props.puzModel, props.words] = getBestPuzModel(
            props,
            vettedCandidates
        );
        return { ...props };
